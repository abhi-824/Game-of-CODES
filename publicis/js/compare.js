function  compare_final(handle_name,handle_name2){
  ...
  async function getUserSubRatCompare() {
    ...
    for (let k = 0; k < jsDataSubRat1.result.length; k++) {
      if (jsDataSubRat1.result[k].problem.rating < 1200) {
        probRat1199U1++;
      } else if (jsDataSubRat1.result[k].problem.rating > 1199 && jsDataSubRat1.result[k].problem.rating < 1600) {
        probRat1200_1599U1++;
      } else if (jsDataSubRat1.result[k].problem.rating > 1599 && jsDataSubRat1.result[k].problem.rating < 2000) {
        probRat1600_1999U1++;
      } else if (jsDataSubRat1.result[k].problem.rating > 1999 && jsDataSubRat1.result[k].problem.rating < 2400) {
        probRat2000_2399U1++;
      } else if (jsDataSubRat1.result[k].problem.rating > 2399 && jsDataSubRat1.result[k].problem.rating < 2800) {
        probRat2400_2799U1++;
    ...
    for (let k = 0; k < jsDataSubRat2.result.length; k++) {
      if (jsDataSubRat2.result[k].problem.rating < 1200) {
        probRat1199U2++;
      } else if (jsDataSubRat2.result[k].problem.rating > 1199 && jsDataSubRat2.result[k].problem.rating < 1600) {
        probRat1200_1599U2++;
      } else if (jsDataSubRat2.result[k].problem.rating > 1599 && jsDataSubRat2.result[k].problem.rating < 2000) {
        probRat1600_1999U2++;
      } else if (jsDataSubRat2.result[k].problem.rating > 1999 && jsDataSubRat2.result[k].problem.rating < 2400) {
        probRat2000_2399U2++;
      } else if (jsDataSubRat2.result[k].problem.rating > 2399 && jsDataSubRat2.result[k].problem.rating < 2800) {
        probRat2400_2799U2++;
    ...
    for (let k = 0; k < jsSubRatOK1.result.length; k++) {
          if (jsSubRatOK1.result[k].verdict == "OK") {
            if (jsSubRatOK1.result[k].problem.rating < 1200) {
              okProbRat1199U1++;
            } else if (jsSubRatOK1.result[k].problem.rating > 1199 && jsSubRatOK1.result[k].problem.rating < 1600) {
              okProbRat1200_1599U1++;
            } else if (jsSubRatOK1.result[k].problem.rating > 1599 && jsSubRatOK1.result[k].problem.rating < 2000) {
              okProbRat1600_1999U1++;
            } else if (jsSubRatOK1.result[k].problem.rating > 1999 && jsSubRatOK1.result[k].problem.rating < 2400) {
              okProbRat2000_2399U1++;
            } else if (jsSubRatOK1.result[k].problem.rating > 2399 && jsSubRatOK1.result[k].problem.rating < 2800) {
          ...
          for (let k = 0; k < jsSubRatOK2.result.length; k++) {
                if (jsSubRatOK2.result[k].verdict == "OK") {
                  if (jsSubRatOK2.result[k].problem.rating < 1200) {
                    okProbRat1199U2++;
                  } else if (jsSubRatOK2.result[k].problem.rating > 1199 && jsSubRatOK2.result[k].problem.rating < 1600) {
                    okProbRat1200_1599U2++;
                  } else if (jsSubRatOK2.result[k].problem.rating > 1599 && jsSubRatOK2.result[k].problem.rating < 2000) {
                    okProbRat1600_1999U2++;
                  } else if (jsSubRatOK2.result[k].problem.rating > 1999 && jsSubRatOK2.result[k].problem.rating < 2400) {
                    okProbRat2000_2399U2++;
                  } else if (jsSubRatOK2.result[k].problem.rating > 2399 && jsSubRatOK2.result[k].problem.rating < 2800) {
  ...
  setTimeout(getUserSubRatOK,5000)
  });
