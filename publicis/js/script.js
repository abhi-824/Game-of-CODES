        ...
        for (let i = 0; i < 8; i++) {
          p[i].addEventListener("click", function (e) {
            ...
            for (let i = 0; i < curr_set.length; i++) {
              ...
              link.innerHTML = `<a href="${p}" target="_blank">Let's Do It</a>  <i class="fa fa-heart" aria-hidden="true"></i>`;
              if (i == 0) {
      ...
      if (i < 0) {
        ...
        for (let i = 0; i < upsolved.length; i++) {
          ...
          th3.innerHTML = `<a class="question" href="${convert_to_link(
            upsolved[i][1][0]
          )}" target="_blank">Let's Do It</a>  <i class="fa fa-heart" aria-hidden="true"></i>`;
          tr.appendChild(th1);
          tr.appendChild(th2);
          tr.appendChild(th3);
  ...
  db.collection("handles")
	...
	for(let i=0;i<fav.length;i++)
	{
		...
		fav[i].addEventListener("click", (e) => {
		  ...
		  let question=fav[i].parentElement.parentElement.firstChild.innerHTML;
