					...
					{	
						...
						next_btn.addEventListener('click', (e) => {
							...
							if(j==4)
							{
								...
								message.innerHTML =
									`Hey boy. Looks like you are nervous. Don't be. I promise I would beat you in every contest and would make you scream!!! If you are still courageous, then go ahead.`;
								next_btn.innerHTML = 'Start the Quest';
						
							}
							if(j==5)
							{
								document.querySelector(".intro_Card").classList.add("bounceOutLeft");
